...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <header class="bg-[#af7051] text-white p-5 font-display">
            ...
            <!-- Navigation -->
                <nav class="space-x-15 font-display text-3xl font-semibold">
                    ...
                    <a href="#about-section" class="hover:text-gray-300 transition">About</a>
        ...
        <!-- About Section -->
        <section id="about-section" class="bg-[#fffbe8] py-12 pt-40 pb-40" style="background-image: url('{{ asset('images/Background/2.png') }}'); background-size: cover; background-position: center;">
            <div>
                <h2 class="text-6xl text-[#f98323] font-bold mb-4 text-center font-display">What is Forkful Diaries?</h2>
            </div>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 px-55">
                <div class="p-6 flex items-center justify-center">
                    <img src="{{ asset('images\About us\photo 1.jpg') }}" alt="About Forkful Diaries" class="w-200 h-100 object-cover rounded-lg shadow-lg">
                </div>
                <div class="p-6">
                    <p class="font-display text-4xl text-[#4d2100] text-center mb-4">
                        Forkful Diaries is a community-driven recipe platform where food enthusiasts can share, discover, and enjoy a wide variety of recipes. From quick weeknight dinners to elaborate holiday feasts, we have something for everyone.
                    </p>
                    <p class="font-display text-4xl text-[#4d2100] text-center mb-4">
                ...
                <div class="p-6 flex items-center justify-center">
                    <img src="{{ asset('images\About us\photo 2.jpg') }}" alt="About Forkful Diaries" class="w-200 h-100 object-cover rounded-lg shadow-lg">
                </div>
            </div>
        </section>
        ...
        <footer class="bg-[#fffbe8] py-12 pt-20" style= "background-image: url('{{ asset('images/Background/3.png') }}'); background-size: cover; background-position: center;">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 px-55">
                <!-- Column 1 -->
                <div>
                    <h3 class="text-5xl text-[#4d2100] font-bold mb-2">Forkful Diaries</h3>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li><a href="{{ url('#about-section') }}" class="hover:underline text-3xl text-[#4d2100]">About</a></li>
                ...
                <div class="md:col-span-3 mt-8">
                    <p class="text-center text-2xl">&copy; {{ date('Y') }} Forkful Diaries. All rights reserved.</p>
                </div>
            </div>
        </footer>
    </body>
